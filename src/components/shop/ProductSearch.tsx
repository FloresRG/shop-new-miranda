        ...
        <div ref={wrapperRef} className="relative w-full max-w-xs lg:max-w-md z-50">
            <div className="relative">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400">
                    {loading ? <span className="block w-4 h-4 border-2 border-primary border-t-transparent rounded-full animate-spin"></span> : <IoSearch />}
                </div>
            </div>
            ...
            {isOpen && results.length > 0 && (
                <div className="absolute top-full mt-2 w-full bg-white dark:bg-darkmode-theme-dark rounded-xl shadow-2xl border border-border dark:border-gray-700 overflow-hidden z-[100] animate-in fade-in slide-in-from-top-2 duration-200">
                            ...
                            <li key={product.id}>
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-bold text-dark dark:text-white truncate">{product.nombre}</p>
                    ...
                    <a href={`/tienda?search=${query}`} className="block text-center text-xs py-2 bg-gray-50 dark:bg-darkmode-theme-light text-primary hover:underline font-bold">
